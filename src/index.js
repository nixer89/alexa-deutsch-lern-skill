...
const languageStrings = {
    ...
    'de': {
        translation: {
            SKILL_NAME: 'deutsch lernen',
            WELCOME_MESSAGE: 'Willkommen bei %s. Du kannst zum Beispiel sagen: Ich möchte konjungieren üben.',
...
var states = {
    ...
    CONFIGMODE: "_KONJUNTION", // Configure Name and Age
    GUESSMODE: "_MATHS", // User is trying to guess an animal
    SPELLMODE: "_", // User is trying to guess the number.
